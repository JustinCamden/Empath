...
public:
	...
	* Does no tracing.
	*/
	UFUNCTION(BlueprintCallable, Category = "EmpathFunctionLibrary|Utility", meta = (WorldContext = "WorldContextObject"))
	...
	UFUNCTION(BlueprintCallable, Category = "EmpathFunctionLibrary|AI", meta = (WorldContext = "WorldContextObject"))
	...
	UFUNCTION(BlueprintCallable, Category = "EmpathFunctionLibrary|AI")
	...
	UFUNCTION(BlueprintPure, Category = "EmpathFunctionLibrary|Utility")
