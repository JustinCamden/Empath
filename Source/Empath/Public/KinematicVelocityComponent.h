...
public:	
	...
	/** The kinematic velocity of this component, averaged from all the recorded velocites within the same time. */
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Empath|Physics")
	...
	/** The last kinematic velocity of this component, calculated with respect to the last frame only. */
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Empath|Physics")
	...
	/** The last kinematic angular velocity of this component, calculated with respect to the last frame only. Expressed in Radians. */
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Empath|Physics")
	...
	/** The last kinematic angular velocity of this component, calculated with respect to the last frame only. Expressed in degrees. */
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Empath|Physics")
