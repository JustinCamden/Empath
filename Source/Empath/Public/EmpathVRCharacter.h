...
DECLARE_STATS_GROUP(TEXT("EmpathVRCharacter"), STATGROUP_EMPATH_VRCharacter, STATCAT_Advanced);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FiveParams(FOnVRCharacterDeathDelegate, FHitResult const&, KillingHitInfo, FVector, KillingHitImpulseDir, const AController*, DeathInstigator, const AActor*, DeathCauser, const UDamageType*, DeathDamageType);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FOnVRCharacterStunnedDelegate, const AController*, StunInstigator, const AActor*, StunCauser, const float, StunDuration);
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FOnVRCharacterStunEndDelegate);
...
public:
	...
	FOnVRCharacterStunnedDelegate OnStunned;
	...
	/** Called when character stops being stunned. */
	UPROPERTY(BlueprintAssignable, Category = "Empath|Combat")
	FOnVRCharacterStunEndDelegate OnStunEnd;
